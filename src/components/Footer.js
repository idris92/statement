        ...
        <>
             <Flex bg='darkgreen' w='100%' px={{base:'20px', md:'150px'}} pt={{base:4, md:12}} align={{base:'left', md:'center'}}direction='column' gap={2} pb={{base:'60px', md:'80px'}}>
                ...
                <Flex direction='column'>
                        <Text fontSize={{base:'14px', md:'16px'}} fontWeight='500' color='disable'>email us:</Text>
                        <Text fontSize={{base:'18px', md:'24px'}} fontWeight='400' color='white'>campaign@yemiosinbajo.ng</Text>
                </Flex>
                <Flex direction='column'>
