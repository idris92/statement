        ...
        <Flex gap={{base:1, md:12}} direction={{base:'column', md:'row'}}>
                ...
                <Flex direction='column' w={{base:'100%', md:'55%'}} gap={3}>
                    <Flex direction='column' gap={2}>
                        ...
                        <Text fontSize={{base:'24px', md:'34px'}} fontWeight='600' color='darkgreen' w='100%' textAlign='justify'><strong>There's nothing more powerful than a consensus of the Nigerian people.</strong></Text>
