        ...
        <Flex gap={{base:3, md:12}} direction={{base:'column', md:'row'}} >
                    ...
                    <Flex direction='column' bg='white' rounded={{base: '12px', md:'24px'}} p={{base:3, md:12}} w={{base:'100%', md:'50%'}}  >
                        <Flex w='100%'>
                            ...
                            <Spacer/>
                            <Select placeholder='Naira' w={{base:'40%', md:'20%'}}>
                        ...
                        <SimpleGrid columns={3} spacing={{base:2, md:4}} py={{base:4, md:8}}>
                            <Button variant='outline' fontSize={{base:'13px', md:'15px'}} fontWeight='500' color='darkgreen'>#5000</Button>
                            <Button variant='outline' fontSize={{base:'13px', md:'15px'}} fontWeight='500' color='darkgreen'>#10000</Button>
                            <Button variant='outline' fontSize={{base:'13px', md:'15px'}} fontWeight='500' color='darkgreen'>#50000</Button>
                            <Button variant='outline' fontSize={{base:'13px', md:'15px'}} fontWeight='500' color='darkgreen'>#100,000</Button>
                            <Button variant='outline' fontSize={{base:'13px', md:'15px'}} fontWeight='500' color='darkgreen'>#500,000</Button>
                            <Button variant='outline' fontSize={{base:'13px', md:'15px'}} fontWeight='500' color='darkgreen'>#1,000,000</Button>
                        </SimpleGrid>
                        ...
                        <Flex py={4} w='100%'>
                        <Button variant='action' color='white' py={{base: 6, md:8}}  fontSize='18px' fontWeight='500' w='100%'>DONATE NOW</Button>
                       </Flex>
